...
async function startServer() {
  try {
    ...
    console.log('--- Application Initialization Start (Awaiting Database Connection) ---');
    ...
    console.error('CRITICAL ERROR: Failed to start server due to dependency injection failure.', error);
    process.exit(1);
  }
}
